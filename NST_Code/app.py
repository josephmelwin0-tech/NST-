...
vgg_path = os.path.join(os.path.dirname(__file__), 'vgg_normalised.pth')
decoder_path = os.path.join(os.path.dirname(__file__), 'experiment', 'final_exp', 'decoder_final.pth')
